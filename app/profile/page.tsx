...
export default function LoginPage() {
	...
	return (
		<div className="flex min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
			...
			<div className="flex-1 flex flex-col justify-start mt-12 items-center px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
					...
					{session?.user ? (
						<Card className="w-full">
							...
							<CardContent className="flex flex-col items-center space-y-4">
								...
								<Button
									onClick={() => signOut()}
									className="w-full bg-red-600 hover:bg-red-700 text-white transition duration-150 ease-in-out">
									Sign Out
								</Button>
							</CardContent>
						</Card>
